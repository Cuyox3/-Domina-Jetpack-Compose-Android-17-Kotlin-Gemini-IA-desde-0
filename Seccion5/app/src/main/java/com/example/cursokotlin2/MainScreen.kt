...
fun MainPreview() {
    Cursokotlin2Theme() {
        MainView(Modifier.padding(top = 24.dp), onContentEvent = { } )
    }
}
...
@Composable
fun MainView(modifier: Modifier = Modifier, onContentEvent: (msg:String) -> Unit) {
    ...
    Column(modifier = modifier.verticalScroll(rememberScrollState())) {
        ...
        { CardDefaults(onSkipAd = { skipAd = !skipAd }, onContentEvent = onContentEvent ) }
        ...
        //
        //https://static.wikia.nocookie.net/yugiohenespanol/images/a/ac/Chica_maga_oscura_%28personaje%29.jpg/revision/latest?cb=20120903042235&path-prefix=es
        ...
        Card(
            ...
            Column(
                ...
                TextField(
                    ...
                    maxLines = 2,
                    label = {
                        Text(text = stringResource(R.string.tf_image_url))
                    },
                    trailingIcon = {
                    ...
                    supportingText = {
                        Text(
                            text = if (urlValue.isNotEmpty() && !URLUtil.isValidUrl(urlValue)) "Invalid Url"
                            else "Required"
                        )
        ...
        OutlinedTextField(
            ...
            modifier = Modifier
                .fillMaxWidth()
                .padding(top = CommonPaddingDefault),
            trailingIcon = {
                Icon(
...
@Composable
fun CardDefaults(onSkipAd: () -> Unit, onContentEvent: (msg:String) -> Unit) {
    ConstraintLayout(
        modifier = Modifier
            .fillMaxSize()
            .padding(CommonPaddingDefault)
    ...
    val buyMsg = stringResource( R.string.buy)

        Button(onClick = { onContentEvent(buyMsg) } , modifier = Modifier.constrainAs(btnBuy) {
            end.linkTo(parent.end)
        ...
        Button(onClick = onSkipAd, modifier = Modifier.constrainAs(btnSkip) {
